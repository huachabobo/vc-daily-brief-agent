...
简报按手机阅读场景设计：顶部是“今日 3 个重点”和“今日变化”，中间按 `AI / 芯片 / 机器人` 分组，正文控制在 5 到 8 条；每条固定包含标题、两句摘要、`why it matters`、`why selected`、来源链接、标签和反馈动作。核心不是“更炫”，而是让 VC 在碎片时间里完成“扫一遍、点两条、标一次反馈”的闭环。
